...
# Write converted_json_str to a JSON file with the same name as this file
file_name = os.path.basename(__file__)
file_name_without_extension = os.path.splitext(file_name)[0]
output_file_path = os.path.join(os.path.dirname(__file__), file_name_without_extension + ".json")

with open(output_file_path, 'w') as output_file:
    output_file.write(converted_json_str)
